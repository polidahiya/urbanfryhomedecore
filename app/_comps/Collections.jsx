...
function Collections() {
  return (
    <div className="p-5 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-1 mt-10">
        {Object.entries(staticdata).map(([key, value], i) => (
          ...
          >
            ...
            />
            <p className="absolute bottom-0 left-0 w-full text-2xl xl:text-xl font-tenor text-white p-2">
              {key.replace(/-/g, " ")}
            </p>
          </Link>
        ))}
