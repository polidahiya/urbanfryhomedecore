...
function Newsletter() {
  ...
  return (
    <div className="fixed min-h-dvh w-full top-0 left-0 flex items-center justify-center bg-black/30 z-30">
      <div className="relative w-full max-w-xl bg-white py-10 px-5 md:px-10 md:py-10">
